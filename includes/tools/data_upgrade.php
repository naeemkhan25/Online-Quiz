...
function hdq_show_need_to_update_data_message()
{
    ...
    <div class="notice notice-error" style="background: darkred; color:#fff;">
        <p style="text-align:center;"><strong>Online QUIZ</strong>. You need to update your quizzes and questions to be compatible with this version. <a href="<?php echo get_admin_url(null, "?page=hdq_tools_data_upgrade"); ?>" class="button" style="font-weight: bold">BEGIN UPDATE</a></p>
    </div>
<?php
}
