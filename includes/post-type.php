<?php
/*
    * Create Online Quiz custom post type and taxonomy
...
function hdq_cpt_quizzes()
{
    $labels = array(
        ...
        'singular_name'       => _x('Online Quiz', 'Post Type Singular Name', 'text_domain'),
        'menu_name'           => __('Online Quiz', 'text_domain'),
        'name_admin_bar'      => __('Online Quiz', 'text_domain'),
    ...
    $args = array(
        'label'               => __('Online Quiz', 'text_domain'),
...
{
    echo '<p>the ablity to modify question data from here has been depricated since Quiz , and removed since Online Quiz . The bulk question edit page still exists so that you can easily delete questions in bulk, or add questions to quizzes in bulk.</p>';
}
