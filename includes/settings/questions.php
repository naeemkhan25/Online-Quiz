...
<p>
	Quiz Shortcode: <span class = "hdq_tooltip_code"><code title = "click to copy to clipboard" class = "hdq_shortcode_copy">[OnlineQuiz quiz = "<?php echo $quizID; ?>"]</code><span class="hdq_tooltip_content">
            ...
            <div id="tab_nav_wrapper">
				<div id="hdq_logo">
					<span class="hdq_logo_tooltip"><img src="<?php echo plugins_url('../images/hd-logo.png', __FILE__); ?>" alt = "Harmonic Design logo">
                        ...
                        <span><strong>Online Quiz</strong> is developed by Harmonic Design. Check out the addons page to see how you can extend Online Quiz even further.</span>
                    	</span>
					</span>
				</div>
                <div id="tab_nav">
