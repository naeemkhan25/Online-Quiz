			...
			"children": [
				{
					...
					"content": "<p>leave blank to use default sharing</p><p></p>"
				},
				{
					"type": "text",
					"name": "hd_qu_tw",
		...
		},
		{
			...
			"children": [
				...
				},
				{
					...
					"tooltip": "By default,  will only show the score as a fraction (example: 9/10). Enabling this will also show the score as a percentage (example: 90%)",
					"options": [
						{
							"label": "",
							"value": "yes"
	...
	"timer": [
		{
			...
			"value": "<p>If the timer is enabled,the quiz will be hidden behind a \"START QUIZ\" button. You can rename this button from the Online Quiz -> About / Options page</p>"
		},
		{
			"type": "col-1-1",
			"children": [
